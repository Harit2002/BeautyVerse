...
function displayBrand() {
  ...
  mainDivv.setAttribute("id","unique");

  let topDiv = document.createElement("div");
  topDiv.setAttribute("id", "topDiv");
  // topDiv.setAttribute("class","one");
  ...
  mainDivv.append(topDiv, mainDiv);
  div.append(mainDivv)
}
...
export { displayLists,displaySkins,displayHair,displayPerosnal,displayMom,displayFrag,displayAyur,displayBrand}
